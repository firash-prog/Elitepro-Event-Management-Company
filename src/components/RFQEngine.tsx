      ...
      <div className="max-w-3xl w-full text-center relative z-10">
        ...
        >
          ...
          <p className="font-serif italic text-brand-gray text-lg">
            Interactive multi-step project brief
          </p>
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="flex flex-col gap-4 max-w-md mx-auto text-left">
                  ...
                  <input 
                    type="email" 
                    placeholder="firash@eliteproeventsksa.com" 
                    className="w-full bg-black/50 border border-brand-teal/20 px-6 py-4 text-white font-sans focus:border-brand-teal outline-none transition-colors"
                  />
                  <input 
                    type="tel" 
                    placeholder="+966 53 706 0245" 
                    className="w-full bg-black/50 border border-brand-teal/20 px-6 py-4 text-white font-sans focus:border-brand-teal outline-none transition-colors"
                  />
                </div>
                ...
                <div className="flex flex-col items-center gap-6 mt-10">
                  <button 
                    className="px-16 py-5 bg-gradient-to-r from-brand-teal to-brand-green text-black text-[0.85rem] font-medium tracking-[0.15em] uppercase border-none cursor-pointer hover:shadow-[0_0_40px_rgba(57,175,150,0.3)] transition-all"
                  >
